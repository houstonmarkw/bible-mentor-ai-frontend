...
export default function Home() {
  return (
    <>
      <Head>
        <title>Bible Mentor AI – Your Personal AI Guide for Bible Study</title>
        <meta
          name="description"
          content="Grow in faith with Bible Mentor AI – personalized devotionals, AI-guided Bible study, and spiritual insight rooted in Scripture."
        />
        <link rel="canonical" href="https://biblementorai.org/" />
      </Head>
