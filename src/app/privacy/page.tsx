...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy – Bible Mentor AI</title>
        <meta
          name="description"
          content="Read the Privacy Policy for Bible Mentor AI. Learn how your spiritual reflections, data, and usage information are protected with care, transparency, and faith-driven integrity."
        />
        <link rel="canonical" href="https://biblementorai.org/privacy" />
      </Head>
